...
void GenerateTextures()
{
	...
	error = load_targa("20.16.tga", width, height, format, type, pixels);
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku 20.16.tga");
		exit(0);
	}
	...
	error = load_targa("c_20110521042857H_SS9.tga", width, height, format, type, pixels);
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku c_20110521042857H_SS9.tga");
		exit(0);
	}
