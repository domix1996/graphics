...
#endif
//}
#include "gltools_extracted.h" //biblioteka odatkowych funkcji graficznych
...
// Odejmij jeden wektor od drugiego
...
// Skaluje wektor przez skalar
void gltScaleVector(GLTVector3 vVector, const GLfloat fScale)
{
	vVector[0] *= fScale; vVector[1] *= fScale; vVector[2] *= fScale;
}

// Pobiera d³ugoœæ wektora do kwadratu
...
// Pobiera d³ugoœæ wektora
GLfloat gltGetVectorLength(const GLTVector3 vVector)
{
	return (GLfloat)sqrt(gltGetVectorLengthSqrd(vVector));
}

// Skaluje wektor wed³ug jego d³ugoœci - tworzy wektor jednostkowy
...
// Bior¹c pod uwagê trzy punkty na p³aszczyŸnie przeciwnie do ruchu wskazówek zegara, oblicz jednostkê normalnie
...
// Przekszta³æ punkt za pomoc¹ macierzy 4x4
...
// Obraca wektor za pomoc¹ macierzy 4x4. Kolumna t³umaczenia jest ignorowana
...
// Pobiera trzy wspó³czynniki równania p³aszczyzny z trzema punktami na p³aszczyŸnie.
void gltGetPlaneEquation(GLTVector3 vPoint1, GLTVector3 vPoint2, GLTVector3 vPoint3, GLTVector3 vPlane)
{
	// Uzyskaj normalny wektor z trzech punktów. Wektor normalny jest pierwszymi trzema wspó³czynnikami do równania p³aszczyzny ...
	gltGetNormalVector(vPoint1, vPoint2, vPoint3, vPlane);

	// Koñcowy wspó³czynnik znaleziony przez substytucjê wsteczn¹
	vPlane[3] = -(vPlane[0] * vPoint3[0] + vPlane[1] * vPoint3[1] + vPlane[2] * vPoint3[2]);
}

// Okreœl odleg³oœæ punktu od p³aszczyzny, bior¹c pod uwagê punkt i równanie p³aszczyzny.
